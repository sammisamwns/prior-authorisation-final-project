...
import { CheckCircle, XCircle, Clock, AlertCircle, FileText, User, Stethoscope, ArrowLeft, Bot } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading AI status dashboard...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">AI Authorization Status</h1>
                <p className="text-sm text-gray-600">AI-powered prior authorization processing</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Prior Authorization AI Processing</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Monitor and manage AI-processed authorization requests with intelligent decision support.
          </p>
        </div>
        ...
        {auths.length === 0 ? (
          <Card className="bg-white shadow-lg border-0 rounded-xl max-w-2xl mx-auto">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">No AI Processing Data</h3>
              <p className="text-gray-600">
                There are currently no prior authorization requests being processed by AI.
              </p>
            </CardContent>
          </Card>
        ) : (
                      ...
                      <div className="flex-1">
                        ...
                        {auth.ai_decision && (
                          <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                            <p className="text-sm">
                              <strong>AI Analysis:</strong> {auth.ai_decision}
                            </p>
                          </div>
                        )}
                        {auth.notes && (
